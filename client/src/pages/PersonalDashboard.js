...
function PersonalDashboard() {
  ...
  const fetchSurvey = async () => {
    ...
    try {
      ...
      if (response.data.success) {
        ...
        // Ensure systemEvaluation object exists
        if (!surveyData.systemEvaluation) {
          surveyData.systemEvaluation = {
  ...
  const handleSystemEvaluationChange = (category, question, value) => {
    setFormData(prev => ({
      ...prev,
      systemEvaluation: {
      ...
      <div className="personal-dashboard-container">
        ...
        <form onSubmit={handleSubmit} className="personal-dashboard-form">
          ...
          <div className="form-section">
            ...
            <p className="rating-instruction">Please evaluate the BSIT Graduate Tracer System. Rate from 1 (Poor) to 5 (Excellent):</p>
